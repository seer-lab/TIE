...
public class CreateGUIBackUp4 extends JFrame{
	...
	public CreateGUIBackUp4(int trace_Num, int thread_Num, List<Integer> transition_Num, List<List<Integer>> transition_states, List<List<String>> transition_states_info){
		int state = 0;
		int randomR = 0;
		int randomG = 0;
		int randomB = 0;
