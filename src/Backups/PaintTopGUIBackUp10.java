...
public class PaintTopGUIBackUp10 extends JPanel{
	...
	public PaintTopGUIBackUp10(int trace_Num, int thread_Num, List<Integer> transition_Num, List<List<Integer>> transition_states, List<List<String>> transition_states_info, List<String> transition_states_error){
		...
		// max_Transitions + 1 because of the error button
		max_Transitions++;
