...
public class PaintTopGUIBackUp12 extends JPanel{
	...
	public PaintTopGUIBackUp12(int trace_Num, int thread_Num, List<Integer> transition_Num, List<List<Integer>> transition_states, List<List<String>> transition_states_info, List<String> transition_states_error){
